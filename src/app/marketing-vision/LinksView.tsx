...
// View interna do Marketing Vision (#view-links). Fica sempre montada e é
// mostrada/escondida pelo switchView do script legado — por isso a sidebar
// permanece e a SPA não recarrega ao entrar/sair.
export default function LinksView() {
  ...
  return (
    <div style={{ maxWidth: 980, margin: '0 auto', color: '#e5e5e5', fontFamily: 'system-ui, sans-serif' }}>
      {/* Header */}
      ...
      {/* Modal do QR Code */}
      {qrFor && (
        <div onClick={() => setQrFor(null)} style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.7)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 9999, padding: 20 }}>
