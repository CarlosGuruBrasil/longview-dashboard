...
async function fetchMetaLive(startDate?: string | null, endDate?: string | null) {
  ...
  const [global, camps, campDetails, adsets, demo, region, platform, device, daily, forms, page] =
    await Promise.allSettled([
      ...
      axios.get<MetaApiList<unknown>>(`${metaBase}/campaigns`, { params: { fields: 'id,name,created_time,start_time,stop_time,status,effective_status,objective,buying_type,daily_budget,lifetime_budget,spend_cap', limit: 1000, ...metaAuth }, timeout: 15000 }),
