...
export default function Error({
  ...
  useEffect(() => {
    console.error('[people-vision] Error caught:', error);
  }, [error]);
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[50vh] p-6 text-center bg-[#09090b] border border-red-500/10 rounded-2xl lv-card">
      ...
      <h2 className="text-base font-bold text-white mb-2">Falha no People Vision</h2>
      <p className="text-xs text-zinc-500 max-w-sm mb-6 leading-relaxed">
        Não foi possível carregar a lista de colaboradores. O restante do dashboard continua disponível.
      </p>
